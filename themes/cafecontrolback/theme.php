...
<head>
    <meta charset="UTF-8">
        <meta name="mit" content="2019-09-04T04:02:42-03:00+28440">
    ...
    <div class="container content">
        <section class="main_footer_content">
            ...
            <article class="main_footer_content_item social">
                <h2>Social:</h2>
                <a target="_blank" class="icon-facebook" href="https://www.facebook.com/<?= CONF_SOCIAL_FACEBOOK_PAGE; ?>"
                   title="CafeControl no Facebook">/CafeControl</a>
                <a target="_blank" class="icon-instagram" href="https://www.instagram.com/<?= CONF_SOCIAL_INSTAGRAM_PAGE; ?>"
